        ...
        <div class="columns is-multiline is-variablefeature-boxes">
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5 ">Sub Items</p>
                        <p>Create sub items to the first menu item.</p>
                    </div>
                </div>
            </div>
            ...
            <div class="column">
                <div class="box has-text-centered has-text-grey feature-box is-radiusless">
                    ...
                    <div class="content">
                        <p class="title is-5">Text instead of icon</p>
                        <p>Insert the text only instead of icon.</p>
                    </div>
                </div>
            </div>
